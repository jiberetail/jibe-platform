...
export const productPages = {
  ...
  retail: {
    ...
    media: {
      ...
      items: [
        ...
        {
          id: "fan-town-discovery",
          label: "Fan Town product discovery",
          eyebrow: "Fan Town / Guided discovery",
          title: "Turn a broad catalog into a fast, branded path to the right product.",
          description:
            "Guide shoppers from sport to team to item in a focused experience designed for the venue, the audience, and the available assortment.",
          src: "assets/jibe-retail/sport-selector.png",
          alt: "Fan Town Jibe Retail screen inviting shoppers to select a sport and begin a guided merchandise search.",
          orientation: "portrait",
          disclosure: "Representative branded experience. Catalogs and discovery paths vary by deployment.",
        },
        {
          id: "rockies-survey",
          label: "Colorado Rockies survey",
          eyebrow: "Colorado Rockies / Branded survey",
          ...
          images: [
            {
              ...
              label: "MLB NYC",
              screenSrc: "assets/jibe-retail/screens/mlb-podium-still.png",
            ...
            },
            {
              ...
              alt: "Jibe Retail podium with a Colorado Rockies wrap and the Dugout Store survey experience on screen.",
              label: "Colorado Rockies",
              screenSrc: "assets/jibe-retail/screens/rockies-podium-still.png",
              videoSrc: "assets/jibe-retail/videos/rockies-podium.mp4",
              screenVariant: "rockies",
            },
          ],
          orientation: "portrait",
          disclosure: "Representative MLB-, Colorado Rockies-, and Fan Town-branded podium visualizations.",
        },
      ],
    },
    reporting: {
  ...
  ai: {
    ...
    hero: {
      ...
      description:
        "Jibe AI autonomously analyzes interaction transcripts to generate structured survey predictions, reveal the evidence behind changing patterns, and recommend what to examine next. When actual customer feedback is available, teams can compare it with those predictions to validate the signal.",
      // COPY REVIEW / BLOCKED — CONTACT-01 / D-10: interim label only; duration and direct scheduling are not approved.
